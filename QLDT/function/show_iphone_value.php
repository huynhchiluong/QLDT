...
if(isset($_GET['price']))
{
	...
	where DienThoai.MaNSX='NSX001' and DienThoai.MaDT= Img.MaDT and GiaDT<'$price' order by GiaDT desc ");
	$output ='';
     if(mysqli_num_rows($query)>0)
     {
     	...
     	while ($row=mysqli_fetch_array($query)) {
			 ...
			 <span style="color:red;align="center";font-size:150%;">'.number_format($row["GiaDT"]).'</span>
			 </div>
			 <hr style= "dashed">
			 <div class="Thongtin" >
