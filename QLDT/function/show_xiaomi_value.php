...
if(isset($_GET['price']))
{
	...
	where DienThoai.MaNSX='NSX004' and DienThoai.MaDT= Img.MaDT and GiaDT<'$price' order by GiaDT desc ");
	$output ='';
...
{ 
	...
	where DienThoai.MaNSX='NSX004' and DienThoai.MaDT= Img.MaDT order by GiaDT desc "; 
	$output1='';
